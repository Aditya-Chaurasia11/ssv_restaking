...
async function main() {
  ...
  await fsp.writeFile(getKeySharesFilePath(1), keySharesItem.toJson(), {
    encoding: "utf-8",
  });
  await keySharesItem.update({ operators });
  await fsp.writeFile(getKeySharesFilePath(2), keySharesItem.toJson(), {
    encoding: "utf-8",
  });
  ...
  await fsp.writeFile(getKeySharesFilePath(3), keySharesItem.toJson(), {
    encoding: "utf-8",
  });
  ...
  await fsp.writeFile(getKeySharesFilePath(4), keyShares.toJson(), {
    encoding: "utf-8",
  });
}
